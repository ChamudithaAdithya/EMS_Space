...
@section('content')
            ...
            <div class="row border rounded-5 p-3 bg-white shadow box-area">
                <div class="col-md-6 rounded-4 d-flex justify-content-center align-items-center flex-column left-box">
                    <div class="featured-image mb-3">
                        <img src="{{ asset('images/Space_Vector_Art.jpg') }}" class="img-fluid"
                ...
                <div class="col-md-6 right-box">
                    <div class="row align-items-center">
                        <div class="header-text mb-4 text-center">
                            ...
                            <cite title="Source Title" style="font-size: 16px; font-weight: 200; color: #808080;">--The
                                Space Applications Division--</cite>
                        </div>
    ...
    {{-- show session error message in a sweet alert box --}}
    @if (@session('error'))
        <script>
            $(function() {
