...
<body>
    ...
    {{-- <h2><u>{{ $event['event_name'] }}</u>Activity</h2> --}}
    <h2 style="text-align: center;"><u>{{ $event['event_name'] }}</u> Activity</h2>
    @endforeach
    ...
    <div class="container">
        ...
        <div class="section1">
            <h4 class="text-center font-weight-bold">Event Organizing Details</h4>
